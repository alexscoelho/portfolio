        ...
        <header className="bg-black">
            <div className="container mx-auto flex justify-between">
                ...
                <div className="inline-flex py-3 px-3 my-6">
                    <SocialIcon url="https://twitter.com/coelhoalexs" className="mr-4" target="_blank" fgColor="#fff" style={{height:35, width:35}}/>
                    <SocialIcon url="https://www.linkedin.com/in/alexsoncoelho/" className="mr-4" target="_blank" fgColor="#fff" style={{height:35, width:35}}/>
                    <SocialIcon url="https://github.com/alexscoelho" className="mr-4" target="_blank" fgColor="#fff" style={{height:35, width:35}}/>
                </div>
            </div>
        </header>
    )
